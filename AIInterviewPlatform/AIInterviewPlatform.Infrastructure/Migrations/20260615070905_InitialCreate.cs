        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    preferred_language_code = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    language_code = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    skill_focus = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    skill_id = table.Column<long>(type: "bigint", nullable: false),
                    match_score = table.Column<decimal>(type: "decimal(5,4)", nullable: false),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_matched_skills", x => x.id);
                    table.CheckConstraint("chk_matched_skill_score", "[match_score] >= 0 AND [match_score] <= 1");
                    table.ForeignKey(
                        name: "fk_matched_skill_analysis",
                        column: x => x.skill_gap_analysis_id,
                        principalTable: "skill_gap_analyses",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_matched_skill_skill",
                        column: x => x.skill_id,
                        principalTable: "skills",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    estimated_days = table.Column<int>(type: "int", nullable: false, defaultValue: 7),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recommendation_title = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ...
                    priority_level = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "MEDIUM"),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_recommendations", x => x.id);
                    table.CheckConstraint("chk_recommendation_priority", "[priority_level] IN ('LOW', 'MEDIUM', 'HIGH')");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_matched_skills_analysis_id",
                table: "matched_skills",
                column: "skill_gap_analysis_id");

            migrationBuilder.CreateIndex(
                name: "idx_matched_skills_skill_id",
                table: "matched_skills",
                column: "skill_id");

            migrationBuilder.CreateIndex(
                name: "uq_matched_skill",
                table: "matched_skills",
            ...
            migrationBuilder.CreateIndex(
                name: "uq_readiness_score_analysis",
                table: "readiness_scores",
                column: "skill_gap_analysis_id",
                unique: true,
                filter: "[skill_gap_analysis_id] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_recommendations_skill_id",
                table: "recommendations",
                column: "skill_id");
            ...
            migrationBuilder.CreateIndex(
                name: "uq_recommendation_analysis_skill",
                table: "recommendations",
                columns: new[] { "skill_gap_analysis_id", "skill_id" },
                unique: true);
